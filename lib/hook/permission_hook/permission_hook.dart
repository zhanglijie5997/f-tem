...
final class PermissionHook {
  ...
  /// 通知权限
  static Future<PermissionStatus> get notification => Permission.notification.status;
  /// 媒体库
  static Future<PermissionStatus> get mediaLibrary => Permission.mediaLibrary.status;

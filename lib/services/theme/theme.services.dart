...
class ThemeService extends GetxService {
  ...
  updateThemeMode(ThemeMode v) {
    ...
    Get.changeTheme(v == ThemeMode.dark ? ThemeDataConfig.light : ThemeDataConfig.light);
...
class ThemeDataConfig {
  static ThemeData get light => ThemeData.light(useMaterial3: true)
      .copyWith(extensions: [CustomTheme.light()]);

  static ThemeData get dark => ThemeData.dark(useMaterial3: true)
      .copyWith(extensions: [CustomTheme.dark()]);
...
class CustomTheme extends ThemeExtension<CustomTheme> {
  ...
  static CustomTheme light() => CustomTheme(
    success: '#F2DFBB'.color(),
    bottomBar: '#252525'.color()
  );

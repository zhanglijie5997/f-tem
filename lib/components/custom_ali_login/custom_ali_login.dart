...
import 'package:art_app/extension/color/color.dart';
...
class CustomAliLogin extends StatefulWidget {
  const CustomAliLogin({Key? key}) : super(key: key);

  @override
  State<CustomAliLogin> createState() => _CustomAliLoginState();
}

class _CustomAliLoginState extends State<CustomAliLogin> {
  final ScrollController _scrollController = ScrollController();
  final List<String> _logs = <String>[];

  late final AuthConfig _authConfig = AuthConfig(
    iosSdk: Config.base.iosSdk!,
    androidSdk: Config.base.androidSdk!,
    enableLog: true,
                ...
                onPressed: () async {
                  try {
                    ...
                    _authConfig.authUIConfig = AlertUIConfig(
                      ...
                      logoConfig: const LogoConfig(
                        logoIsHidden: false,
                        logoImage: Assets.assetsImagesHome,
                      ),
                      sloganConfig: SloganConfig(
                        sloganIsHidden: false,
